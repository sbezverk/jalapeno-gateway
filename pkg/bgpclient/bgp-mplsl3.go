...
func (bgp *bgpClient) AdvertiseVPNv4(prefix []*pbapi.MPLSL3Prefix) error {
...
func (bgp *bgpClient) WithdrawVPNv4(prefix []*pbapi.MPLSL3Prefix) error {
	if err := validateVPNv4Prefix(prefix); err != nil {
		return err
	}
...
func validateVPNv4Prefix(prefix []*pbapi.MPLSL3Prefix) error {
	for _, p := range prefix {
		if p == nil {
			continue
		}
...
func (bgp *bgpClient) advertiseVPNv4Prefix(ctx context.Context, prefix *pbapi.MPLSL3Prefix) error {
